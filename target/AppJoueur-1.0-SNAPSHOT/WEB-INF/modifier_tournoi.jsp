...
<head>
  ...
  <body>
    ...
    <main role="main" class="container">
      <div class="starter-template"><h1>Modifier un Tournoi</h1></div>
    </main><!-- /.container -->
      ...
      <form class="needs-validation" method="post" novalidate>
        <div class="form-row">
          <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" style="width:400px;" id="validationCustom01" name="tournoiNom" value="${ tournoi.nom }" required pattern=".{1,20}" />
        ...
        <div class="form-row">
          <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" style="width:400px;" id="validationCustom02" name="tournoiCode" value="${ tournoi.code }" required pattern="[A-Z]{2}">
